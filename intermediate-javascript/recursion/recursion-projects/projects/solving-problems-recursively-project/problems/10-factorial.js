...
/**
 * This function takes an integer num, and returns the
 * factorial of num. Assume the value of num is greater
 * than or equal to 1.
 * 
 * A factorial is the number get when multiplying a number
 * by itself minus one all the way down to 1 (but not 0)!
 * We represent them with an exclamation point, also sometimes
 * called a "bang" in programming.
 *
 * @param {number} num
 *     This is the number we need to get its factorial.
 *
 * @returns
