...
/**
 * This function accepts a callback and a delay in *seconds*.
 * The function should set a timeout on the given callback for
 * the specified amount of time. Feel free to use the built-in
 * setTimeout in your implementation.
 *
