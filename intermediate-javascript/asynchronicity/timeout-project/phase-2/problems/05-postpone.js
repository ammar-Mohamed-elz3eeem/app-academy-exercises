 ...
 * as arguments. `postpone` should return a new function. When
 * the returned function is called, it should invoke the callback
 * after the given delay.
 *
 * @param {CallableFunction} cb
 *     This is the callback to be used in setTimeout.
 *
 * @param {number} delay
 *     This is the delay in milliseconds to be used in setTimeout.
 *
 * @returns
 *     return a new function. When the returned function is called,
 *     it should invoke the callback after the given delay.
 */
