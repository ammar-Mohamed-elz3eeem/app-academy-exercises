...
/**
 * This function will accept a number and return
 * a function. When the function returned by lazyAdder
 * is invoked it will again accept a number, (secondNum),
 * and then return a function. When the last mentioned
 * function is invoked with a number, (thirdNum), it will
 * FINALLY return a number.
 *
 * @param {number} num
 *     This is the number to sum to.
 *
 * @returns
 *     a function that takes secondNum as parameter and
 *     returns a second function with parameter thirdNum
 *     and returns the result of adding firstNum to
 *     secondNum to thirdNum.
 */
