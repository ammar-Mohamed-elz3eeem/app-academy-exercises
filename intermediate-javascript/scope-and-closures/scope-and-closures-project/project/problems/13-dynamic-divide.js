...
/**
 * This function will return a new function that when
 * invoked will divide the argument number by the divisor.
 *
 * @param {number} divisor
 *     This is number to divide any number by it.
 *
 * @returns
 *     a new function that when invoked will divide the
 *     argument number by the divisor.
 */
