...
/**
 * This function function will return a new function
 * that will allow us to create new separate custom
 * multiply functions.
 *
 * @param {number} num
 *     This is the number to multiply any number by.
 *
 * @returns
 *     a new function that will allow us to create new
 *     separate custom multiply functions.
 */
