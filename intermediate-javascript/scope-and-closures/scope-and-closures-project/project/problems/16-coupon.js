...
/**
 * This function take a number to apply as a discount,
 * and will return a function that accepts an array of
 * prices. Every call to the function returned by coupon
 * will return the array of prices with the discount
 * applied.
 *
 * @param {number} discount
 *     This is the percent for the discount to apply to
 *     closure elements.
 *
 * @returns
 *     a function that accepts an array of prices. Every
 *     call to the function returned by coupon will return
 *     the array of prices with the discount applied.
 */
function coupon (discount) {
  // Your code here
  return (array) => array.map(price => price * (1 - discount))
}
