 ...
 * accept a string to add to the sandwich order (which
 * will start off with a default "tomato" ingredient),
 * separating each incoming ingredient with "and".
 *
 * @returns
 *     another function that will accept a string to add
 *     to the sandwich order (which will start off with
 *     a default "tomato" ingredient), separating each
 *     incoming ingredient with "and".
 */
function sandwichMaker() {
  // Your code here
  let currentSandwich = "One sandwich with tomato";
  return (ingredient) => {
    currentSandwich += " and " + ingredient;
