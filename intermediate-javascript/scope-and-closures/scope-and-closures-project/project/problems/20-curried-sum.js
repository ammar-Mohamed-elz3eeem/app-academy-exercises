...
/**
 * This function takes an integer(how many numbers to sum)
 * and returns a function that can be successively called
 * with single arguments until it finally returns a sum.
 *
 * @param {number} numArgs
 *     This is the number of numbers to sum.
 *
 * @returns
 *     a function that can be successively called with
 *     single arguments until it finally returns a sum.
 */
