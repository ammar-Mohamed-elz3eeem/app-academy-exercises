 ...
 * as arguments. The function will return an array
 * of new elements obtained by calling the callback
 * on each element of the array, passing in the
 * element.
 *
 * @param {Array} array
 *     This is the array to map over its elements.
 *
 * @param {CallableFunction} cb
 *     This is the callback mapper function.
 *
 * @returns
 *     an array of new elements obtained by calling
