...
/**
 * This function takes in an object containing a number
 * of keys that have the word 'apple' contained within
 * them. The `appleCounter` function will be in charge
 * of returning the number of keys that contain the
 * word "apple".
 *
 * @param {Object} appleObj
 *     This is the object to search in its keys.
 *
 * @returns
 *     the number of keys that contain the word "apple".
 */
