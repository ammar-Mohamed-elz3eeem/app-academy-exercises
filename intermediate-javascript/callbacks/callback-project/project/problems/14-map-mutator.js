 ...
 * arguments. The function should pass each element
 * and index into the callback and use the result to
 * overwrite elements of the original array, mutating
 * the array.
 *
 * @param {Array} array
 ...
 *
 * @param {cb} callback
 *     This is the callback that edits array elements.
 */
