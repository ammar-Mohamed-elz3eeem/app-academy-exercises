...
/**
 * This function that accepts an array and two callbacks
 * as arguments. The function should return a new array
 * where elements are replaced with the results of calling
 * the second callback on the element only if calling the
 * first callback on the element results in true. If
 * calling the first callback on an element results in
 * false, then the element should not be changed in the
 * new array.
 *
 * @param {Array} array
 *     This is the array to filter.
 *
 * @param {CallableFunction} filterCb
 *     This is callback filter.
 *
 * @param {CallableFunction} mapCb
 *     This is the callback mapper.
 *
 * @returns
 *     a new array where elements are replaced with the
 *     results of calling the second callback on the
 *     element only if calling the first callback on the
 *     element results in true. If calling the first
 *     callback on an element results in false, then the
 *     element should not be changed in the new array.
 */
