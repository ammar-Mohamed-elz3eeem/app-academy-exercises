...
/**
 * This function accepts an array and a callback as an
 * argument. The function should call the callback for
 * each element of the array, passing in the element and
 * its index. The function should return a boolean
 * indicating whether or not at least one element of the
 * array returns true when passed into the callback.
 *
 * @param {Array} array
 ...
 *
 * @returns
 *     a boolean indicating whether or not at least one
 *     element of the array returns true when passed into
 *     the callback.
 */
