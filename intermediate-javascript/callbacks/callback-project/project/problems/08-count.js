 ...
 * arguments. The function should return the number
 * of elements of the array that return true when
 * passed to the callback.
 *
 * @param {Array} Array
 *     This is the array to count the elements from.
 *
 * @param {CallableFunction} cb
 *     This is the callback to call on every element.
 *
 * @returns
 *     the number of elements of the array that return
