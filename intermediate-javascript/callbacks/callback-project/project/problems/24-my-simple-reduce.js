 ...
 * The function should mimic the behavior of the built in
 * Array#reduce, utilizing the first element of the array as
 * the default accumulator. In other words, the function
 * should begin with the first element of the array as the
 * accumulator and call the callback for each of the
 * remaining elements in the array, passing in the current
 * accumulator and current element into the callback. Upon
 * calling the callback, the accumulator should be set to
 * the result of the callback.
 *
 * @param {Array} array
 *     This is the array that needs to be reduced.
 *
 * @param {CallableFunction} callback
 *     This is the callback to run on elements to reduce.
 *
 * @returns
 *     the result of reducing the array.
 */
