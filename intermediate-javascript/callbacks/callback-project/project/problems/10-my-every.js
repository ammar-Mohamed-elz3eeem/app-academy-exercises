 ...
 * arguments. The function should return a boolean
 * indicating whether or not all elements of the
 * array return true when passed into the callback.
 *
 * @param {Array} array
 ...
 *
 * @returns
 *     a boolean indicating whether or not all elements
 *     of the array return true when passed into the
 *     callback.
 */
