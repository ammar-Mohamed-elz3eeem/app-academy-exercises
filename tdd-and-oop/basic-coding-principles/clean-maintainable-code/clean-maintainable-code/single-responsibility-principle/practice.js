...
/**
 * This function prints recipe ingredients.
 *
 * @param {string} pieType
 *     This is the type of pie to print its ingredients.
 */
function printRecipeIngredients(recipe, pieType) {
...
/**
 * This function Print the cost of each pie based on
 * the cost of each ingredient.
 *
 * @param {Object} recipe
 *     This is the recipe to calculate its cost.
 *
 * @returns
 *     The cost of each pie based on the cost of each
 *     ingredient.
 */
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
	...
	for (let i = 0; i < pieQuantity; i++) {
		...
		printRecipeIngredients(recipe, pieType);
	...
	const costOfPie = getRecipeCost(recipe);
