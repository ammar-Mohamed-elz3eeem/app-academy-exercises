...
const newWorldData = require('../data/world-data');

class World {
	/**
	 * This is the default constructor of the World class.
	 */
	constructor() {
		this.rooms = {};
	}
	...
	loadWorld(worldData) {
		const roomList = newWorldData.rooms;
		const itemList = newWorldData.items;
