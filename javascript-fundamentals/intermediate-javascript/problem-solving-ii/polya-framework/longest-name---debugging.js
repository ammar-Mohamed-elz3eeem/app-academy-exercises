/**
 * This function takes an array of names and returns
 * the longest. If there's a tie, it returns the first
 * name of the longest length.
 *
 * @param {Array} names
 *     This is the array containing list of names to
 *     operate on and extract longest name from.
 *
 * @returns
 *     returns the longest. If there's a tie, it returns
 *     the first name of the longest length.
 */
