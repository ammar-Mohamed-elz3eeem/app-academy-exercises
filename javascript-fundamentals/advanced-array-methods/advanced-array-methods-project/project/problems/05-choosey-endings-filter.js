...
/**
 * This function accepts an array of words and a suffix string
 * as arguments. The function should return a new array
 * containing the words that end in the given suffix. If the
 * value passed in is not an array, return an empty array.
 *
 * @param {Array<string>} words
 *     This is the words array to filter.
 *
 * @param {string} suffix
 *     This is the string to check if exist on single
 *     word or not
 *
 * @returns
